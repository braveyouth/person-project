...
public class PersonMapperService {
    ...
    public BoolString checkReq1001(Req1001 req1001) throws Exception{
        ...
        //身份证号是否已经存在
        if(personMapper.hasIdCard(EncrypteUtil.encrypt(req1001.getIdCard()))>0){
        ...
        //当前获取赠险名额是否达到限制
        if(personMapper.limitReach()>=6000){
     ...
     * @param req1002
     */
    public Page<Res1001> selectService(Req1002 req1002) throws Exception {
        Page<Res1001> page = personMapper.selectDao(new RowBounds(req1002.getPage(),req1002.getPageSize()));

        List<Res1001> list = page.getResult();
     ...
     * @param req1002
     */
    public void exportService(Req1002 req1002) throws Exception {
        ...
        writer.write(selectService(req1002),true);
        writer.close();
    }
    ...
    public int sumService() {
        ...
        return personMapper.limitReach();
